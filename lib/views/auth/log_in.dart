              ...
              children: [
                ...
                FilledButton(
                  ...
                  style: FilledButton.styleFrom(
                    ...
                    padding: EdgeInsets.symmetric(vertical: 20, horizontal: 97),
                  ),
                  child: Text("Login"),
                ),SizedBox(height: 50,),
                Row(
                  ...
                  children: [
                    Text("Don’t have an account?",style: TextStyle(fontSize: 12,fontWeight: FontWeight.w400),),
                    TextButton(onPressed: () {
                      
                    },style: TextButton.styleFrom(foregroundColor: Color(0xffD75D72).withValues(alpha: .4)), child: Text("Register",style: TextStyle(fontSize: 12,fontWeight: FontWeight.w600,color: Color(0xffD75D72)),))
                  ],
                )
              ],
            ),
